...
class ProjectViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Asigna automáticamente al usuario autenticado que realiza la petición
    ...
    def add_member(self, request, pk=None):
        ...
        if project.owner != request.user:
            return Response(
                {"detail": "No tienes permiso para agregar miembros."},
    ...
    def change_owner(self, request, pk=None):
        ...
        if project.owner != request.user:
            return Response(
                {
                    "detail": "Solo el dueño actual puede transferir la propiedad."
                },
                status=status.HTTP_403_FORBIDDEN,
            )
...
class TaskViewSet(viewsets.ModelViewSet):
    ...
    def assign(self, request, pk=None):
        ...
        if task.project.owner != request.user:
            return Response(
                {
                    "detail": "Solo el dueño del proyecto puede asignar tareas."
                },
                status=status.HTTP_403_FORBIDDEN,
            )
    ...
    def complete(self, request, pk=None):
        ...
        if actual_hours is None or not str(actual_hours).isdigit():
            return Response(
                {
                    "error": "Debe proporcionar 'actual_hours' como un número entero válido."
                },
